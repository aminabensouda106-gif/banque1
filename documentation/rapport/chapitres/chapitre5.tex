...
L'interface comporte le logo AmanaBank centré, des champs avec icônes Bootstrap, un bouton de connexion doré et deux encadrés d'aide rappelant les identifiants de démonstration. Un lien «\,Retour à l'accueil\,» permet de revenir à la landing sans utiliser le bouton précédent du navigateur.
...
La fiche compte affiche le numéro, le type (courant, épargne, professionnel), le solde, le statut et les actions disponibles (blocage, clôture, relevé). Les badges colorés distinguent visuellement les statuts.
...
\begin{figure}[H]
    ...
    \caption{Fiche détail compte — solde, statut et actions}
    \label{fig:compte}
\end{figure}
...
Des cartes individuelles affichent chaque compte (type, numéro, solde, badge de statut). Le tableau des \textbf{5 dernières opérations} permet de télécharger les reçus PDF.
...
\begin{figure}[H]
    ...
    \IfFileExists{figures/captures/portal-dashboard.png}{%
        ...
        \fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}
        \textit{[Capture client : \texttt{portal-dashboard.png} — compte \texttt{CD789012}]}
        \vspace{2cm}}}%
    }
