...
4. Sur la fiche commande → passer en **En cours de traitement** puis **Livrée**
5. Insister : **aucun impact sur le solde**

## 7. Supervision (1 min)

1. Déconnexion → login **chef** / `chef123`
2. **Tableau de bord** : indicateurs et opérations récentes
3. **Journal d'audit** : montrer les actions `BILL_PAYMENT_CREATED`, `CHECKBOOK_ORDER_CREATED`
...
- « La base évolue par **Flyway** (migrations V1 à V9). »
